 ...
 * @param {string} parameters.alias Alias for the parameter.
 ...
 * @property {string} name Alias of the parameter.
 ...
 * @memberof Parameter
 * @instance
 * @param {string} key Key to lookup the parameter from the provider.
